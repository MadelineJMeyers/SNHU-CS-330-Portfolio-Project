 ...
 *
 *  This method is used for defining the material values
...
void SceneManager::DefineObjectMaterials() {
	...
	clayMaterial.specularColor = glm::vec3(0.3f, 0.3f, 0.4f);
	clayMaterial.shininess = 0.3;
	clayMaterial.tag = "plastic";
...
void SceneManager::LoadSceneTextures(){
	...
	// Set each texture into memory
	bReturn = CreateGLTexture("textures/frostedglass_purple.jpg", "bottle");

	bReturn = CreateGLTexture("textures/redplastic.jpg", "plastic_wrap");

	bReturn = CreateGLTexture("textures/stainedwood.jpg", "table");

	bReturn = CreateGLTexture("textures/brushedmetal.jpg", "can");
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[3].position", -10.0f, 22.0f, 8.0f);
	m_pShaderManager->setVec3Value("lightSources[3].diffuseColor", 0.0f, 0.0f, 0.0f);
	m_pShaderManager->setVec3Value("lightSources[3].specularColor", 0.4f, 0.2f, 0.2f);
...
{
	// Created individual functions for each shape to prevent confusion while working with each shape.
	RenderTable();
	RenderMartiniGlass();
	RenderGrenedineBottle();
	RenderShaker();
	RenderCanOfSoda();
}

/*** This function handles the transformation and shader settings for the table.***/
...
// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(13.0f, 1.0f, 15.0f);
...
/*** This function handles the transformation and shader settings for the Martini Glass object ***/
void SceneManager::RenderMartiniGlass() 
{
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-3.5f, 0.25f, -3.0f);
	...
	SetShaderColor(0.3, 0.1, 0.3, 0.6);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-3.5f, 1.0f, -3.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-3.5f, 8.25f, -3.0f);
	...
	SetShaderColor(0.3, 0.1, 0.8, 0.7);
	SetShaderMaterial("dull");
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-3.5f, 9.5f, -3.0f);
	...
	SetShaderColor(0.4, 0.1, 0.7, 0.3);
	SetShaderMaterial("glass");
	// draw the mesh with transformation values
	m_basicMeshes->DrawConeMesh();
}

/*** This function handles the transformation and shader settings for the Grenadine Bottle ****/
void SceneManager::RenderGrenedineBottle() 
{
	// declare the variables for the transformations
	glm::vec3 scaleXYZ;
	float XrotationDegrees = 0.0f;
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(2.0f, 4.75f, -4.0f);
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.51f, 2.0f, 1.51f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(2.0f, 2.75f, -4.0f);
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.5f, 0.85f, 0.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(2.0f, 8.45f, -4.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(2.0f, 9.25f, -4.0f);
...
void SceneManager::RenderShaker() {
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-6.5f, 0.25f, 3.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-6.5f, 4.25f, 3.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-6.5f, 5.25f, 3.0f);
...
// set the XYZ scale for the mesh
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-6.5f, 6.0f, 3.0f);
...
void SceneManager::RenderCanOfSoda()
{
	glm::vec3 scaleXYZ;
	float XrotationDegrees = 0.0f;
	float YrotationDegrees = 0.0f;
...
// set the XYZ scale for the mesh
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(4.5f, 0.25f, 0.0f);
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.24f, 1.24f, 0.75f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(4.5f, 4.25f, 0.0f);
...
/******************************************************************/
// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.45f, 0.5f, 1.45f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(4.5f, 3.80f, 0.0f);
	...
	SetShaderColor(0.85, 0.85, 0.85, 1);
	SetShaderMaterial("metal");
	SetShaderTexture("can");
	// draw the mesh with transformation values
	m_basicMeshes->DrawCylinderMesh();
